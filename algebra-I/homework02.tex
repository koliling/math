...
\begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item Question 19: Let $H$ be a subgroup of the finite group $G$ and
        ...
        \begin{proof}
          ...
          between $H$ and $\mathcal{O}$ which we have just proven, each
  ...
  \item Section 2.1
    \begin{enumerate}
      \item Question 4: Give an explicit example of a group $G$ and an
        infinite subset $H$ of $G$ that is closed under the group operation
        but is not a subgroup of $G$.

        \begin{proof}
          Consider the case where $G=\mathbb{Z}$ under the addition
          operation and $H=\mathbb{Z}^+$. Then $H$ is closed under addition
          but it is not a group because it does not have an identity.
        \end{proof}
