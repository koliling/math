  ...
  \begin{enumerate}[label={\bf(\alph*)}]
    ...
    \item Prove that $I_2$, $I_3$, and $I_3'$ are prime ideals in $R$.
      \begin{proof}
        ...
        Again from the Third Isomorphism Theorem for rings, we have
        $R/I_3\cong (R/\langle3\rangle)/(I_3/\langle3\rangle)$. From the
        claim in the first paragraph, we have $[R:\langle3\rangle]=9$.
        Then from Lagrange's theorem, $[I_3:\langle3\rangle]$ equals 1, 3,
        or 9. But since $3$ does not divide $2+\sqrt{-5}$ in $R$, $I_3$ is
        a strict superset of $\langle3\rangle$, so $[I_3:\langle3\rangle]$
        equals 3 or 9, which implies that $[R:I_3]$ is 1 or 3. Now from
        Question 5a of Section 8.3, we have shown that $I_3$ is
        non-principal, and therefore it must be strictly contained in $R$
        (otherwise $I_3=\langle1\rangle$, which is principal). Thus
        $[R:I_3]=3$, and so $R/I_3\cong\mathbb{Z}_3$ as a ring, which is a
        field. Hence $R/I_3\cong\mathbb{Z}_3$ is an integral domain, which
        implies that $I_3$ is a prime ideal of $R$. \\

        The argument for $I_3'$ being a prime ideal of $R$ is identical to
        the argument for $I_3$ above.
      \end{proof}

    \item Show that the factorizations in (a) imply the equality of ideals
      $\langle6\rangle=\langle2\rangle\langle3\rangle$ and $\langle6\rangle
      =\langle1+\sqrt{-5}\rangle\langle1-\sqrt{-5}\rangle$. Show that these
      two ideal factorizations give the same factorization of the ideal
      $\langle6\rangle$ as the product of prime ideals.
