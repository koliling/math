...
\it \textbf{Section 10.4 Q3:} Show that
  ...
  \begin{proof}
    ...
    First, note that $\mathbb{C}\otimes_\mathbb{R}\mathbb{C}$ can be
    spanned as an $\mathbb{R}$-module by four elements
    $\{1\otimes1,i\otimes1,1\otimes i,i\otimes i\}$, because given any
    $a,b,c,d\in\mathbb{R}$, we can write
    \begin{align*}
      &\;(a+bi)\otimes(c+di)\\
    ...
    Similarly, $\mathbb{C}\otimes_\mathbb{C}\mathbb{C}$ can be spanned by
    the same four elements, however because
    $i\otimes1=i\cdot(1\otimes1)=1\otimes 1$ and $i\otimes i=i\cdot
    i\cdot(1\otimes1)=-1\cdot(1\otimes 1)$ in
    $\mathbb{C}\otimes_\mathbb{C}\mathbb{C}$,
    $\mathbb{C}\otimes_\mathbb{C}\mathbb{C}$ can be spanned by just two
    elements $\{1\otimes1,i\otimes1\}$. Furthermore, these two elements are
    distinct in $\mathbb{C}\otimes_\mathbb{C}\mathbb{C}$.
  \end{proof}
\end{document}
