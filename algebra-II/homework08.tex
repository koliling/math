...
\it \textbf{DF 13.4.4:} Determine the splitting field and its degree over
  ...
  \begin{proof}
    ...
    $x^3-2$, therefore $[\mathbb{Q}(\sqrt[3]{2}):\mathbb{Q}]=3$.
    Also, the minimal polynomial of $\sqrt{2}i$ over $\mathbb{Q}$ is
    $x^2+3$, therefore $[\mathbb{Q}(\sqrt{2}i):\mathbb{Q}]=2$. Hence
    $[\mathbb{Q}(\sqrt[3]{2},\sqrt{3}i):\mathbb{Q}]$ must divide both 2 and
    3, and yet be smaller than the product $2\times3=6$. Therefore
    $\mathbb{Q}(\sqrt[3]{2},\sqrt{3}i)=6$.
  \end{proof}
