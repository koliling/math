...
\textbf{Kunen I.16.6:} \it (ZF$^-$) Let $\text{pow}(x,y)$ be $\forall z
  ...
  \begin{proof}
    ...
    as a subset of $a$, the rank of $c$ cannot exceed the rank of $a$ by
    Lemma I.9.24.4, therefore $c$ must be contained in $R(\gamma)$ since
    $a$ is contained in $R(\gamma)$. \\

    Note: Not sure why it is necessary for $\gamma$ to be a limit ordinal?
  \end{proof}

\textbf{Kunen I.16.7:} \it (ZFC$^-$) Let $\gamma$
\end{document}
