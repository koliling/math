...
\textbf{Kunen I.16.7:} \it (ZFC$^-$) Let $\gamma>\omega_1$ be a limit
  ...
  \begin{proof}
    ...
    a countable elementary substructure $M\preceq R(\gamma)$ that contains
    $\omega$ and $\omega_1$. As an elementary substructure, $M\equiv
    R(\gamma)$. Let $A$ be the Mostowski collapse of $A$. Then
  \end{proof}
\end{document}
