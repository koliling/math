...
\it \textbf{Soare 6.1.4:} Modify the proof of Theorem 6.1.1 to build an
  ...
  \begin{proof}
    ...
    %To determine which $A_j^s$ need to be
    %extended in order to preserve the computation, we fix any enumeration
    %$\{(x_r,j_r)\}_{r\in\omega}$ of $\omega^2$ so that we may consider
    %$\oplus_j A_j$ as a function in $2^\omega$. \\
