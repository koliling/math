    ...
    \begin{enumerate}[label={(\roman*)}]
      \item Use the method of Exercise 2.4.11 to prove that we may assume
        ...
        \begin{proof}
          ...
          \[q(\langle e_0,e_1\rangle) :=\psi(g(j_0fh(\langle
            e_0,e_1\rangle),\; j_1fh(\langle e_0,e_1\rangle))\langle
            ,\;g(j_1fh(\langle e_0,e_1\rangle)),\; j_0fh(\langle
            e_0,e_1\rangle) \rangle)\]
          will give us the required total function.

          %Such $g$ can be constructed by applying the SMN theorem on the
          %partial recursive function
          %\begin{align*}
          %  \varphi_{g(\langle e_0,e_1\rangle)}(x) :=
          %  \begin{cases}
          %    0, &\text{if}\; \psi(\langle e_0,e_1\rangle)\downarrow\;
          %      \text{and}\; 2|x\; \text{and}\;
          %      \varphi_{e_0}(x/2)\downarrow,\\
          %    0, &\text{if}\; \psi(\langle e_0,e_1\rangle)\downarrow\;
          %      \text{and}\; 2\not|x\; \text{and}\;
          %      \varphi_{e_1}((x-1)/2)\downarrow,\\
