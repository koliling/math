    ...
    \begin{enumerate}[label={(\roman*)}]
      \item Use the method of Exercise 2.4.11 to prove that we may assume
        ...
        \begin{proof}
          ...
          Following the hint from Exercise 2.4.11, we first effectively
          change $W_{e_0}$ and $W_{e_1}$ to the empty set if and only if
          $\psi(\langle e_0,e_1\rangle)$ does not halt. By the SMN theorem,
          there are total recursive functions $h_0,h_1$ that performs this
          conversion:
          \begin{align*}
            W_{h_0(\langle e_0,e_1\rangle)} :=
            \begin{cases}
          ...
          With SMN theorem again, we can find total recursive functions
          $f_0,f_1$ that adds $W_a$ to $W_{e_0}$ and adds $W_b$ to
          $W_{e_1}$:
          \begin{align*}
            W_{f_0h_0(\langle e_0,e_1\rangle)} :=
            \begin{cases}
          ...
          and
          \begin{align*}
            W_{f_1h_1(\langle e_0,e_1\rangle)} :=
            \begin{cases}
          ...
          Then by composing with the $g$ function to perform the $\backslash$
          operation,
          \begin{align*}
            W_{g(f_0h_0(\langle e_0,e_1\rangle),\; f_1h_1(\langle
            e_0,e_1\rangle))} :=
            \begin{cases}
          ...
          and
          \begin{align*}
            W_{g(f_1h_1(\langle e_0,e_1\rangle)),\; f_0h_0(\langle
            e_0,e_1\rangle)} :=
            \begin{cases}
          ...
          \[q(\langle e_0,e_1\rangle) :=\psi(\langle g(f_0h_0(\langle
            e_0,e_1\rangle),\; f_1h_1(\langle e_0,e_1\rangle))
            ,\;g(f_1h_1(\langle e_0,e_1\rangle)),\; f_0h_0(\langle
            e_0,e_1\rangle) \rangle)\]
