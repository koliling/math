    ...
    \begin{enumerate}
      ...
      \item \it Show that in fact there are only two possibilities for
        ...
        \begin{proof}
          ...
          \begin{align*}
            \binom{[n]}{m} &=\{A_1,\ldots,A_k\} \cup
              \{A_{k+1},\ldots,A_{\binom{n}{m}}\},\\
            \binom{[n]}{m+1} &=\{B_1,\ldots,B_k\} \cup
              \{B_{k+1},\ldots,B_{\binom{n}{m}}\},\\
            \mathcal{F} &=\{A_1,\ldots,A_k\} \cup
              \{B_{k+1},\ldots,B_{\binom{n}{m}}\},\\
