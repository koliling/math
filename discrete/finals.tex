    ...
    \begin{enumerate}
      ...
      \item \it Show that the maximum size of a 2-distance set in
        ...
        \begin{proof}
          ...
          \[f_i(x) =\left(\sum_{k=1}^n (x_k-v_{i,k})^2 -r^2\right)
          \left(\sum_{k=1}^n (x_k-v_{i,k})^2 -s^2\right),\]
          ...
          To tighten the bound, we follow Blokhui's proof [1]. Consider
          the set
          ...
          \begin{equation}
            \lambda_ir^2s^2 +\sum_{j=1}^n \kappa_jv_{i,j} +\mu=0.
            \label{eqn:2}
          \end{equation}

          Substituting $x=ce_i$ into equation~\eqref{eqn:1} gives
          \begin{equation}
            \sum_{i=1}^m \lambda_i f_i(x) +c\kappa_j +\mu=0.
            \label{eqn:3}
          \end{equation}
        \end{proof}
    \end{enumerate}
