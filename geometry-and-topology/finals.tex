...
\begin{enumerate}[label={\bf Q\arabic*:}]
  \item \it Define $\mathbb{C}\mathbb{P}^n$ to be the set of equivalence
    ...
    \begin{proof}
      We can realize the complex projective space in a similar manner that
      we realized the real projective space in the notes (Basic example in
      ...
      \[U_i\cong U_{x_i>0}\rightarrow V.\]
      The set
      \[\mathcal{A}=\{\phi_i:U_i\rightarrow V\}\]
      then forms a smooth atlas for $\mathbb{C}\mathbb{P}^n$. Thus, the
      ...
      %inverse
      %\[\phi_i^{-1}(y_1,\ldots,y_n)=(y_1:\ldots:y_{i-1}:y_{i+1}:\ldots:y_n)\]
