    ...
    \begin{enumerate}
      ...
      \item Prove that the map $\pi:\mathbb{C}\rightarrow\mathbb{C}$
        ...
        \begin{proof}
          ...
          union of disjoint open subsets each homeomorphic to
          $\mathcal{O}$. It suffices to consider open balls containing
          $\pi(z)=0$ since the open balls form a basis of the topology on
          $\mathbb{C}$.
        \end{proof}
    \end{enumerate}
\end{enumerate}
