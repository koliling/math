    ...
    \begin{enumerate}
      \item Let $x_1,\ldots,x_k\in S^2$ be distinct points and let $p\in
        ...
        \begin{proof}
          ...
          $k-1$ points from $\mathbb{R}^2$, we get a space homeomorphic to
          $X_{k-1}:=\mathbb{R}^2\setminus\{x_2,\ldots,x_k\}$, which is a
          strong deformation retract to the wedge of $k$ circles at a fixed
          point $p$. Such a wedge has fundamental group $F_{k-1}$.
          Summarizing,
          \begin{align*}
