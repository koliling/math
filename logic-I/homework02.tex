...
\begin{enumerate}
  ...
  \item Give an example of two structures $\mathcal{M}$ and $\mathcal{N}$
    ...
    \begin{proof}
      ...
      $\mathcal{N}=\langle\mathbb{N}\cup\mathbb{N}i,<\rangle$. The identity
      map $id$ will embed $\mathcal{M}$ into $\mathcal{N}$. To embed the
      $\mathcal{N}$ to $\mathcal{M}$, consider the embedding function
      $\theta:\mathbb{N}\cup\mathbb{N}i\rightarrow\mathbb{N}\cup\{i\}$
      given by:
      ...
      \begin{equation*}
        \theta(x) =
          \begin{array}{ll}
            ...
            2x/i-1  & \text{if}\; x=ki\; \text{for some}\; k\in\mathbb{N}^+ \\
          \end{array}
      \end{equation*}
    \end{proof}
