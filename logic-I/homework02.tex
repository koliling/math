...
\begin{enumerate}
  ...
  \item Find an infinite structure $\mathscr{M}$ in a finite language whose
    ...
    \begin{proof}
      $\mathscr{M}=\langle\mathbb{N},<\rangle$ is one such structure. Let
  ...
  \item Find a structure $\mathscr{M}$ and a bijective homomorphism
    $\alpha:\mathscr{M}\rightarrow\mathscr{M}$ such that $\alpha$ is not an
    isomorphism.
