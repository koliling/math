...
\begin{enumerate}[label={\bf Q\arabic*:}]
  ...
  \item Let $T$ be the theory of infinite vector spaces over $\mathbb{Q}$.
    ...
    \begin{proof}
      ...
      $e$ of a basis of $V$, and the remaining $q\in V_\mathbb{Q}$ to
      $q\cdot e\in V$. It is routine to check that this map will preserve
      the axioms of vector spaces, which are associativity and
      commutativity of addition, identity element of addition, inverse
      element of addition, compatibility of scalar multiplication with
      field multiplication, identity element of scalar multiplication, and
      the distributive laws. Also, this map will be injective because
      $q\cdot e=0$ if and only if $q=0$ because $e$ is an element of a
      basis of $V$. \\
      ...
      Therefore, $V_\mathcal{Q}$ is a prime model of $T$, and $S_n(T)$ is
