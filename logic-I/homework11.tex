...
\begin{enumerate}[label={\bf Q\arabic*:}]
  \item Let $T$ be an inductive theory in a countable language and $\kappa$
    ...
    \begin{proof}
      ...
      %Also, since $T$ is inductive, it is equivalent to a
      %$\forall\exists$-theory (Theorem 11.9), thus the models of
      %$T=T_{\forall\exists}$ are exactly the existentially-closed
      %substructures of models of $T$ (Lemma 11.5)
