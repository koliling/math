\begin{frame}{Bi-Hyperimmune sets}
  \begin{define}[Hyperimmune, Bi-hyperimmune]
    ...
    such that for every $n\in\omega$, the $n$-th element of $B$ is larger
    than the $n$-element of $A$. $A$ is \textbf{bi-hyperimmune} if both $A$
    and $\bar{A}$ are hyperimmune.
  \end{define}
...
\begin{frame}{Class of sets computing subsets of hyperimmune is null}
  ...
  $A$ must be below the largest element found.
\end{frame}
