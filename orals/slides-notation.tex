...
\begin{frame}{WWKL asserts Randomness}
  ...
  solutions is random by stating
...
\begin{frame}{WWKL, WKL, KL}
  The solutions of an instance of Weak Konig's Lemma (WKL), however, may
  ...
  \vspace{2em}
  Konig's Lemma is an even stronger statement, asserting solutions even for
  non-binary trees as long as they are finitely branching: 
  \begin{thm*}[Weak Konig's Lemma]
...
\begin{frame}{KL, RT $\leq_{\text{soc}}$ WKL}
  ...
  problem, fix one of its solutions, and choose the WKL instance whose only
  path codes that solution as an path in $2^\omega$. By definition of
  $\leq_{\text{soc}}$, the original problem reduces to this WKL instance.
