...
\begin{frame}{KL, RT $\leq_{\text{soc}}$ WKL}
  Under $\leq_{\text{soc}}$, WKL is very powerful. Given any KL or RT
  problem, fix one of its solutions, and choose the WKL instance whose only
  path codes that solution. By definition of $\leq_{\text{soc}}$, the
  original problem reduces to this WKL instance.
