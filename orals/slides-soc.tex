...
\begin{frame}{Lebesgue measure}
  \begin{define*}[Outer, inner measure]
    ...
    \mathcal{A}\subseteq \bigcup_{n\in\omega} [\sigma_n]\right\}.\]
    Its \textbf{inner measure} is $\mu_*(\mathcal{A}):=
    1-\mu^*(\bar{\mathcal{A}})$.\\
    E.g. $\mu^*([\sigma]) =\mu_*([\sigma]) =2^{-|\sigma|}$.
  \end{define*}
