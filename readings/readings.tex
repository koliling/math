...
\section{Infinite Injury Constructions}
  ...
  \begin{equation}
    \liminf_{s\in\omega} \max\{r(0,s),\ldots,r(e-1,s)\} <\infty.
    \label{eqn:liminf}
  \end{equation}
  \COMMENT{We want higher priority restraints to fall at the same
  time infinitely often. Draw diagram.}\\
