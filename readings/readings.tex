...
\subsection{Promptly Simple Sets}
  ...
  \begin{recall}
    ...
    be computed effectively, i.e. there exists a recursive functions
  ...
  \begin{proof}
    We show every r.e. set $B$ either has a PS degree or is cappable with
    witness $A$. We construct an r.e. $A$ such that the
  \end{proof}
\end{document}
